...
4. De volgende stap is het toevoegen van opleggingen. Er zijn een aantal standaard opties, maar je kan ook handmatig translatie- en rotatierichtingen vastzetten. De opleggingen kan je plaatsen op de knopen of langs een staaf (in dat geval wordt er een nieuwe knoop gemaakt). ALs je een scharnierende oplegging toevoegt is de oplegging enkel scharnierend verbonden aan de staaf, in de staaf zelf wordt geen scharnier toegevoegd.
5. Nu kunnen we verder met inwendige scharnieren. In een raamwerk is standaard alles momentvast verbonden. Per staaf kan je voor elk uiteinde aangeven of dit een scharnier moet worden door op een deel van die staaf te klikken. Als twee aansluitende staven scharnierend zijn verbonden is het niet nodig om beide staafuiteindes scharnierend te maken, ééntje is genoeg.
...
Dit onderwerp is [dit jaar in les 4](https://collegeramavideoportal.tudelft.nl/catalogue/ctb2210/presentation/c67d273f54834a27aed86d02824e62281d?academicYear=2026-2027-ctb2210) gepresenteerd in collegevorm van 0:04:00 tot 0:35:45 (TU Delft login vereist). [In 2025 is dit onderwerp in les 2](https://collegerama.tudelft.nl/Mediasite/Channel/public-ceg-ctb2210/watch/d57b95f9b71e4f218640c870c28a88031d?sortBy=most-recent) gepresenteerd in collegevorm (publiek beschikbaar).
