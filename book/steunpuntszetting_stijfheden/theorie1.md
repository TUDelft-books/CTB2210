...
Deze oefening is aangepast van de [deze theoriepagina](https://oit.tudelft.nl/CEG-mechanics-BSc/statically_inderminate/support_settlement.html) van {cite:ts}`CEG_mechanics_BSc`
