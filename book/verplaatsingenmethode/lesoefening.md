...
Constructie, lijkend op het voorbeeld in hoofdstuk 4.3.1 uit het boek Mechanica, Statisch onbepaalde constructies en bezwijkanalyse {cite:p}`Hartsuijker2016`, $EI >> EA, EA = 9000 \ \rm{kN}, EA_{\rm{CF}} = 36000 \ \rm{kN}$
```
...
Statisch bepaald systeem, $EI >> EA, EA = 9000 \ \rm{kN}, EA_{\rm{CF}} = 36000 \ \rm{kN}$
```
